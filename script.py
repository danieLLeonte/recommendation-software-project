...
# Insert food types into data structure (LinkedList)
...
# Insert restaurant data into data structure (LinkedList of LinkedLists)mam
...
while len(selected_food_type) == 0:
    ...
    if len(matching_types) > 1:
      print("\nWith those beginning letters, your choice are {}".format(matching_types))
    ...
    if len(matching_types) == 1:
        ...
        # After finding food, retrieving restaurant data
        if select_type == 'y':
            selected_food_type = matching_types[0]
            print("\nSelected Food Type: " + selected_food_type)
